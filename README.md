...
This module uses [input helpers](https://www.home-assistant.io/integrations/?cat=helper&search=input) to store user inputs. You can see all of the input helpers generated by this module on [the helpers page](http://homeassistant.local:8123/config/helpers).
