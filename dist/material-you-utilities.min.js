...
Does not apply to cards that are explicitly set to outlined like in settings.`,init:{config:{icon:"mdi:card",options:["elevated","filled","outlined","transparent"]}},card:{config:{select:{mode:"dropdown",options:[{value:"elevated",label:"Elevated"},{value:"filled",label:"Filled"},{value:"outlined",label:"Outlined"},{value:"transparent",label:"Transparent"}]}},tabBarIndex:1},handler:rM},navbar:{domain:"input_boolean",default:"on",name:"Show Navigation Bar",description:`Show/hide the navigation bar at the bottom of views.
Does not restore the default Home Assistant navigation bar.`,init:{config:{icon:"mdi:navigation"}},card:{config:{boolean:{}},tabBarIndex:1},handler:rA},harmonize:{domain:"input_boolean",default:"off",name:"Harmonize Semantic Colors",description:"Adjust static/semantic colors to be closer in hue to the theme primary color.",init:{config:{icon:"mdi:palette-swatch"}},card:{config:{boolean:{}},tabBarIndex:2},handler:tD},image_url:{domain:"input_text",default:"",name:"Base Color Source Image Path/URL",description:`Path/URL to an image to extract the base color from.
Use a query string like ?i=1 (between 0 and 3 inclusive) to choose alternate color options.`,init:{config:{icon:"mdi:image",min:0,max:255}},card:{config:{text:{}},tabBarIndex:2},handler:tO},css_file:{domain:"input_text",default:"",name:"CSS Path/URL",description:"Path/URL to a CSS file to apply to the page and iframe roots for defining custom properties.",init:{config:{icon:"mdi:language-css3",min:0,max:255}},card:{config:{text:{}},tabBarIndex:2},handler:rR}};async function rL(e,t,r){return e.callWS({type:`${t}/create`,...r})}async function rH(e,t,r,a){return e.callWS({type:`${t}/update`,[`${t}_id`]:r,...a})}async function rN(e,t,r){e.callWS({type:`${t}/delete`,[`${t}_id`]:r})}async function rV(e,t){if(!t)return!0;let r=new Event("hass-action",{bubbles:!0,composed:!0});return r.detail={action:"tap",config:{tap_action:{action:"fire-dom-event",confirmation:t}}},e.dispatchEvent(r),new Promise(e=>{let t,r=()=>{clearTimeout(t),window.removeEventListener("ll-custom",a),window.removeEventListener("dialog-closed",i)},a=()=>{r(),e(!0)};window.addEventListener("ll-custom",a);let i=()=>{t=setTimeout(()=>{r(),e(!1)},100)};window.addEventListener("dialog-closed",i)})}async function rU(e){return new Promise(async t=>{let r=(await tA()).hass,a=r.user?.id,i=window.browser_mod?.browserID?.replace(/-/g,"_");if(r.connection.connected&&a){let n=[];for(let e in rO){let t=n.find(t=>t.handler==rO[e].handler);t?t.inputs.push(e):(t={inputs:[e],handler:rO[e].handler},n.push(t))}let o=[];for(let t of n){let n=[];if(e.id?n=[...t.inputs.map(t=>t_(t,e.id))]:(n=[...t.inputs.map(e=>t_(e)),...t.inputs.map(e=>t_(e,a))],i&&n.push(...t.inputs.map(e=>t_(e,i)))),r.user?.is_admin)o.push(r.connection.subscribeMessage(()=>t.handler(e),{type:"subscribe_trigger",trigger:{platform:"state",entity_id:n}},{resubscribe:!0}));else for(let a of n)o.push(r.connection.subscribeMessage(r=>{"error"in r&&(console.error(r.error),tM(r.error)),t.handler(e)},{type:"render_template",template:`{{ states("${a}") }}`,entity_ids:a,report_errors:!0}))}t(Promise.all(o))}else setTimeout(()=>t(rU(e)),100)})}var rz=function(e,t,r,a){var i,n=arguments.length,o=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,r):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,a);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(o=(n<3?i(o):n>3?i(t,r,o):i(t,r))||o);return n>3&&o&&Object.defineProperty(t,r,o),o};customElements.get("disk-color-picker")||r(899);let rj=`${tk}-theme`;class rZ extends es{constructor(){super(...arguments),this.tabBarIndex=0,this.tabs=["theme","styles","other"],this.unsubscribers=[]}async handleDeleteHelpers(e){if(!await rV(this,{text:"Are you sure you want to delete these helpers?"}))return;for(let e in rO){let t=t_(e,this.dataId);this.hass.states[t]&&await rN(this.hass,rO[e].domain,t.split(".")[1])}let t="Global input entities cleared";if(this.dataId){let e="";e=this.dataId==this.hass.user?.id?this.hass.user?.name??"":this.hass.states[this.dataId]?.attributes.friendly_name??this.dataId,t=`Input entities cleared for ${e}`}t$(this,t)}buildDeleteHelpersButton(){return j`<div class="delete button" @click="${this.handleDeleteHelpers}">Delete Helpers</div>`}async handleCreateHelpers(e){let t="";for(let e in this.dataId&&(t=` ${this.hass.states[this.personEntityId??""]?.attributes?.friendly_name??this.personEntityId??this.dataId}`),rO){let r=t_(e,this.dataId);if(!this.hass.states[r]){let a=r.split(".")[1];await rL(this.hass,rO[e].domain,{name:a,...rO[e].init.config}),await rH(this.hass,rO[e].domain,a,{name:`${tw} ${rO[e].name}${t}`,...rO[e].init.config});let i=rO[e].domain,n=rF[i],o={entity_id:r};switch(i){case"input_text":case"input_number":o.value=rO[e].default;break;case"input_select":o.option=rO[e].default;break;case"input_boolean":n=`turn_${rO[e].default}`}await this.hass.callService(i,n,o)}}let r="Global input entities created";t&&(r=`Input entities created for${t}`),t$(this,r)}buildCreateHelpersButton(){return j`<div class="create button" @click="${this.handleCreateHelpers}">Create Helpers</div>`}handleTabBar(e){let t=this.tabs.indexOf(e.detail.name);this.tabBarIndex!=t&&(this.tabBarIndex=t)}buildTabBar(e,t,r){return j`<sl-tab-group @sl-tab-show="${t}">${r.map((t,r)=>j`<sl-tab slot="nav" panel="${t}" .active="${r==e}">${t}</sl-tab>`)}</sl-tab-group>`}async handleSelectorChange(e){let t=e.target.getAttribute("field"),r=e.detail.value,a=rO[t].domain,i=rF[a],n={entity_id:t_(t,this.dataId)};switch(a){case"input_text":case"input_number":n.value=r||rO[t].default;break;case"input_select":n.option=r||rO[t].default}await this.hass.callService(a,i,n),this.requestUpdate()}buildSelector(e,t,r,a){let i,n=t_(t,this.dataId),o=this.hass.states[n]?.state;return i="input_boolean"===rO[t].domain?"on"==o:o??rO[t].default,j`<ha-selector .hass="${this.hass}" .name="${e}" .selector="${r}" .value="${i??a}" .label="${e}" .placeholder="${a}" .required="${!1}" field="${t}" @value-changed="${this.handleSelectorChange}"></ha-selector>`}async handleKeyDown(e){!e.repeat&&["Enter"," "].includes(e.key)&&(e.preventDefault(),(e.target.parentElement?.className.replace("button","").trim()==="reset"?this.handleResetClick:this.handleMoreInfoClick).call(this,new window.MouseEvent("click",e),e.target))}async handleResetClick(e,t){let r=(e.target??t).getAttribute("field"),a=rO[r].domain,i=rF[a],n={entity_id:t_(r,this.dataId)};switch(a){case"input_text":case"input_number":n.value=rO[r].default;break;case"input_select":n.option=rO[r].default;break;case"input_boolean":i=`turn_${rO[r].default}`}await this.hass.callService(a,i,n),this.requestUpdate()}buildResetButton(e){return j`<div class="reset button"><ha-icon @click="${this.handleResetClick}" @keydown="${this.handleKeyDown}" tabindex="0" field="${e}" .icon="${"mdi:restore"}"></ha-icon></div>`}handleMoreInfoClick(e,t){let r=t_((e.target||t).getAttribute("field"),this.dataId),a=new Event("hass-more-info",{bubbles:!0,cancelable:!0,composed:!0});a.detail={entityId:r},this.dispatchEvent(a)}buildMoreInfoButton(e){let t=t_(e,this.dataId),r=this.hass.states[t]?.attributes.icon;return j`<pre class="description">${rO[e].description}</pre><div class="more-info button"><ha-icon @click="${this.handleMoreInfoClick}" @keydown="${this.handleKeyDown}" tabindex="0" field="${e}" .icon="${r}"></ha-icon></div>`}buildRow(e){let t=t_(e,this.dataId);if(!this.hass.states[t])return"";let r=this.hass.states[t]?.state;if("base_color"==e){let t,a=e=>{clearTimeout(t);let r=e.target,a=r.value;t=setTimeout(()=>{let e=new Event("value-changed");e.detail={value:a},r.dispatchEvent(e)},100)};return j`<div class="column"><disk-color-picker field="${e}" value="${r}" @change="${a}" @keyup="${a}" @value-changed="${this.handleSelectorChange}"></disk-color-picker><div class="subrow"><div class="row">${this.buildMoreInfoButton(e)}<div class="label">${rO[e].name}</div></div><div class="row"><div class="label secondary">${r||rO[e].default}</div>${this.buildResetButton(e)}</div></div></div>`}let a="";"harmonize"==e&&(a=j`<div class="row semantic-colors">${["pink","red","deep-orange","orange","amber","yellow","lime","light-green","green","teal","cyan","light-blue","blue","indigo","deep-purple","purple"].map(e=>j`<div class="semantic-color" style="background:var(--${e}-color)"></div>`)}</div>`);let i=rO[e].card.config;return"input_number"==rO[e].domain?(i.min=this.hass.states[t]?.attributes?.min??-1,i.max=this.hass.states[t]?.attributes?.max??1,i.step=this.hass.states[t]?.attributes?.step??.01):"input_boolean"==rO[e].domain&&(r="on"==r),j`${this.buildMoreInfoButton(e)} ${this.buildSelector(rO[e].name,e,i,r)}${a} ${rO[e].card.resetButton?this.buildResetButton(e):""}`}setupIds(){this.dataId&&!this.personEntityId&&(this.personEntityId=Object.keys(this.hass.states).find(e=>e.startsWith("person.")&&this.hass.states[e].attributes.user_id==this.dataId))}applyThemeMode(){if(this.darkMode!=this.hass.themes?.darkMode){this.darkMode=this.hass.themes?.darkMode;let e=this.shadowRoot?.getElementById(rj);if(e){let t=[];for(let[e,r]of Object.entries(this.hass.themes?.themes[tw].modes?.[this.darkMode?"dark":"light"]??{}))t.push(`--${e}: ${r};`);e.textContent=`
					:host {
						${t.join("\n")}
					}
				`}}}render(){this.setupIds();let e="Global";this.dataId&&(e=this.hass.states[this.personEntityId??""]?.attributes?.friendly_name??this.personEntityId??this.dataId);let t=Object.keys(rO).filter(e=>rO[e].card.tabBarIndex==this.tabBarIndex);this.hass.states[t_("spec",this.dataId)]?.state!="2025"&&(t=t.filter(e=>"platform"!=e));let r={};for(let e of t)r[e]=this.buildRow(e);for(let e in r)r[e]||delete r[e];return j`<ha-card .hass="${this.hass}" .header="${e}">${this.personEntityId?j`<div class="subtitle">ID: ${this.dataId}</div>`:""} ${this.buildTabBar(this.tabBarIndex,this.handleTabBar,this.tabs)}<div class="card-content">${Object.keys(r).length!=t.length?tT(this.hass.user?.is_admin?"Press Create Helpers to create and initialize inputs.":"Some or all input helpers not setup! Ask an Home Assistant administrator to do so.",this.hass.user?.is_admin?"info":"error"):""} ${Object.keys(r).map(e=>j`<div class="row ${e}">${r[e]}</div>`)}</div>${this.hass.user?.is_admin?j`<div class="card-actions">${this.buildCreateHelpersButton()}${this.buildDeleteHelpersButton()}</div>`:""}</ha-card><style id="${rj}"></style>`}firstUpdated(){let e=async()=>{let t=structuredClone(this.hass.themes?.themes[tw]);delete t.modes;let r=Object.entries(t);if(r.length){for(let[e,t]of r)this.style.setProperty(`--${e}`,t);return}setTimeout(()=>e(),100)};e();let t={targets:[this],id:this.dataId??""};for(let e of[tO,tR,rM,rR])e(t)}updated(){this.applyThemeMode();let e=this.shadowRoot?.querySelector("disk-color-picker");if(e&&!e.shadowRoot?.getElementById(rj)){let t=document.createElement("style");t.id=rj,t.textContent=`
			...
			`,e.shadowRoot?.appendChild(t)}}connectedCallback(){super.connectedCallback(),rU({targets:[this],id:this.dataId??""}).then(e=>{this.unsubscribers=e})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribers.forEach(async e=>{e()})}static get styles(){return l`:host{width:var(--width);font-family:var(--font-family)}.card-content{display:flex;flex-direction:column;padding:16px;margin:0;gap:20px}.subtitle{margin-top:-24px;padding:0 16px 16px;color:var(--secondary-text-color);font-size:var(--md-sys-typescale-label-large-size,14px);font-weight:var(--md-sys-typescale-label-large-weight,500);line-height:var(
					...
					var(--mdc-fab-box-shadow)
						...
						var(--mdc-fab-box-shadow)
					)}.theme-mode-fab:hover::after{opacity:.08}}.theme-mode-fab:active::after,.theme-mode-fab:focus-visible::after{opacity:.18}`}}rq([eh()],rY.prototype,"hass",void 0),rq([eh()],rY.prototype,"narrow",void 0),rq([eh()],rY.prototype,"route",void 0),rq([eh()],rY.prototype,"panel",void 0),rq([ed()],rY.prototype,"tabBarIndex",void 0),rq([ed()],rY.prototype,"darkModeIndex",void 0),async function(){if(window.MaterialYouInit)return;window.MaterialYouInit=!0,r_(window),tE(document.querySelector("html"),`${tw} Utilities v${t.i8}`);let e=await tA();new MutationObserver(async t=>{for(let r of t)for(let t of r.addedNodes)if("IFRAME"==t.nodeName){let t=await tC(e.shadowRoot,"iframe"),r=await tP(t,"contentWindow");r_(r);let a=await tP(r,"document"),i={targets:[await tC(a,"body")]};for(let e of[tR,rM,rR])await e(i)}}).observe(e.shadowRoot,{subtree:!0,childList:!0}),customElements.define(`${tk}-config-card`,rZ),customElements.define(`${tk}-panel`,rY);let r=async t=>{if(t>1e4)return;let a=e.hass?.themes?.theme;if(!a)return void setTimeout(()=>{r(t)},2*t);if(a.includes(tw)){let e={targets:[await tC(document,"html")]};for(let t of[tO,tR,rM,rR,rA])await t(e)}};r(100),rU({});let a=async()=>{let e=(await tA()).hass,t=e.user?.id;if(e.connection.connected&&t){e.connection.subscribeEvents(()=>tR({}),"themes_updated"),e.user?.is_admin&&e.connection.subscribeEvents(e=>{e?.data?.service=="set_theme"&&setTimeout(()=>tR({}),1e3)},"call_service");return}setTimeout(()=>a(),100)};a()}()})()})();