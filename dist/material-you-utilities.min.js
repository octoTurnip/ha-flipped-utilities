...
Use a query string like ?i=1 (between 0 and 3 inclusive) to choose alternate color options.`,init:{config:{icon:"mdi:image",min:0,max:255}},card:{config:{text:{}},tabBarIndex:2},handler:tO},css_file:{domain:"input_text",default:"",name:"CSS Path/URL",description:"Path/URL to a CSS file to apply to the page and iframe roots for defining custom properties.",init:{config:{icon:"mdi:language-css3",min:0,max:255}},card:{config:{text:{}},tabBarIndex:2},handler:rB}};async function rH(e,t,r){return e.callWS({type:`${t}/create`,...r})}async function rN(e,t,r,a){return e.callWS({type:`${t}/update`,[`${t}_id`]:r,...a})}async function rV(e,t,r){e.callWS({type:`${t}/delete`,[`${t}_id`]:r})}async function rU(e,t){if(!t)return!0;let r=new Event("hass-action",{bubbles:!0,composed:!0});return r.detail={action:"tap",config:{tap_action:{action:"fire-dom-event",confirmation:t}}},e.dispatchEvent(r),new Promise(e=>{let t,r=()=>{clearTimeout(t),window.removeEventListener("ll-custom",a),window.removeEventListener("dialog-closed",i)},a=()=>{r(),e(!0)};window.addEventListener("ll-custom",a);let i=()=>{t=setTimeout(()=>{r(),e(!1)},100)};window.addEventListener("dialog-closed",i)})}async function rz(e){return new Promise(async t=>{let r=(await tA()).hass,a=r.user?.id,i=window.browser_mod?.browserID?.replace(/-/g,"_");if(r.connection.connected&&a){let n=[];for(let e in rL){let t=n.find(t=>t.handler==rL[e].handler);t?t.inputs.push(e):(t={inputs:[e],handler:rL[e].handler},n.push(t))}let o=[];for(let t of n){let n=[];if(e.id?n=[...t.inputs.map(t=>t_(t,e.id))]:(n=[...t.inputs.map(e=>t_(e)),...t.inputs.map(e=>t_(e,a))],i&&n.push(...t.inputs.map(e=>t_(e,i)))),r.user?.is_admin)o.push(r.connection.subscribeMessage(()=>t.handler(e),{type:"subscribe_trigger",trigger:{platform:"state",entity_id:n}},{resubscribe:!0}));else for(let a of n)o.push(r.connection.subscribeMessage(r=>{"error"in r&&(console.error(r.error),tM(r.error)),t.handler(e)},{type:"render_template",template:`{{ states("${a}") }}`,entity_ids:a,report_errors:!0}))}t(Promise.all(o))}else setTimeout(()=>t(rz(e)),100)})}var rj=function(e,t,r,a){var i,n=arguments.length,o=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,r):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,a);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(o=(n<3?i(o):n>3?i(t,r,o):i(t,r))||o);return n>3&&o&&Object.defineProperty(t,r,o),o};customElements.get("disk-color-picker")||r(899);let rZ=`${tk}-theme`;class rq extends es{constructor(){super(...arguments),this.tabBarIndex=0,this.tabs=["theme","styles","other"],this.unsubscribers=[]}async handleDeleteHelpers(e){if(!await rU(this,{text:"Are you sure you want to delete these helpers?"}))return;for(let e in rL){let t=t_(e,this.dataId);this.hass.states[t]&&await rV(this.hass,rL[e].domain,t.split(".")[1])}let t="Global input entities cleared";if(this.dataId){let e="";e=this.dataId==this.hass.user?.id?this.hass.user?.name??"":this.hass.states[this.dataId]?.attributes.friendly_name??this.dataId,t=`Input entities cleared for ${e}`}t$(this,t)}buildDeleteHelpersButton(){return j`<div class="delete button" @click="${this.handleDeleteHelpers}">Delete Helpers</div>`}async handleCreateHelpers(e){let t="";for(let e in this.dataId&&(t=` ${this.hass.states[this.personEntityId??""]?.attributes?.friendly_name??this.personEntityId??this.dataId}`),rL){let r=t_(e,this.dataId);if(!this.hass.states[r]){let a=r.split(".")[1];await rH(this.hass,rL[e].domain,{name:a,...rL[e].init.config}),await rN(this.hass,rL[e].domain,a,{name:`${tw} ${rL[e].name}${t}`,...rL[e].init.config});let i=rL[e].domain,n=rO[i],o={entity_id:r};switch(i){case"input_text":case"input_number":o.value=rL[e].default;break;case"input_select":o.option=rL[e].default;break;case"input_boolean":n=`turn_${rL[e].default}`}await this.hass.callService(i,n,o)}}let r="Global input entities created";t&&(r=`Input entities created for${t}`),t$(this,r)}buildCreateHelpersButton(){return j`<div class="create button" @click="${this.handleCreateHelpers}">Create Helpers</div>`}handleTabBar(e){let t=this.tabs.indexOf(e.detail.name);this.tabBarIndex!=t&&(this.tabBarIndex=t)}buildTabBar(e,t,r){return j`<sl-tab-group @sl-tab-show="${t}">${r.map((t,r)=>j`<sl-tab slot="nav" panel="${t}" .active="${r==e}">${t}</sl-tab>`)}</sl-tab-group>`}async handleSelectorChange(e){let t=e.target.getAttribute("field"),r=e.detail.value,a=rL[t].domain,i=rO[a],n={entity_id:t_(t,this.dataId)};switch(a){case"input_text":case"input_number":n.value=r||rL[t].default;break;case"input_select":n.option=r||rL[t].default}await this.hass.callService(a,i,n),this.requestUpdate()}buildSelector(e,t,r,a){let i,n=t_(t,this.dataId),o=this.hass.states[n]?.state;return i="input_boolean"===rL[t].domain?"on"==o:o??rL[t].default,j`<ha-selector .hass="${this.hass}" .name="${e}" .selector="${r}" .value="${i??a}" .label="${e}" .placeholder="${a}" .required="${!1}" field="${t}" @value-changed="${this.handleSelectorChange}"></ha-selector>`}async handleKeyDown(e){!e.repeat&&["Enter"," "].includes(e.key)&&(e.preventDefault(),(e.target.parentElement?.className.replace("button","").trim()==="reset"?this.handleResetClick:this.handleMoreInfoClick).call(this,new window.MouseEvent("click",e),e.target))}async handleResetClick(e,t){let r=(e.target??t).getAttribute("field"),a=rL[r].domain,i=rO[a],n={entity_id:t_(r,this.dataId)};switch(a){case"input_text":case"input_number":n.value=rL[r].default;break;case"input_select":n.option=rL[r].default;break;case"input_boolean":i=`turn_${rL[r].default}`}await this.hass.callService(a,i,n),this.requestUpdate()}buildResetButton(e){return j`<div class="reset button"><ha-icon @click="${this.handleResetClick}" @keydown="${this.handleKeyDown}" tabindex="0" field="${e}" .icon="${"mdi:restore"}"></ha-icon></div>`}handleMoreInfoClick(e,t){let r=t_((e.target||t).getAttribute("field"),this.dataId),a=new Event("hass-more-info",{bubbles:!0,cancelable:!0,composed:!0});a.detail={entityId:r},this.dispatchEvent(a)}buildMoreInfoButton(e){let t=t_(e,this.dataId),r=this.hass.states[t]?.attributes.icon;return j`<pre class="description">${rL[e].description}</pre><div class="more-info button"><ha-icon @click="${this.handleMoreInfoClick}" @keydown="${this.handleKeyDown}" tabindex="0" field="${e}" .icon="${r}"></ha-icon></div>`}buildRow(e){let t=t_(e,this.dataId);if(!this.hass.states[t])return"";let r=this.hass.states[t]?.state;if("base_color"==e){let t,a=e=>{clearTimeout(t);let r=e.target,a=r.value;t=setTimeout(()=>{let e=new Event("value-changed");e.detail={value:a},r.dispatchEvent(e)},100)};return j`<div class="column"><disk-color-picker field="${e}" value="${r}" @change="${a}" @keyup="${a}" @value-changed="${this.handleSelectorChange}"></disk-color-picker><div class="subrow"><div class="row">${this.buildMoreInfoButton(e)}<div class="label">${rL[e].name}</div></div><div class="row"><div class="label secondary">${r||rL[e].default}</div>${this.buildResetButton(e)}</div></div></div>`}let a="";"harmonize"==e&&(a=j`<div class="row semantic-colors">${["pink","red","deep-orange","orange","amber","yellow","lime","light-green","green","teal","cyan","light-blue","blue","indigo","deep-purple","purple"].map(e=>j`<div class="semantic-color" style="background:var(--${e}-color)"></div>`)}</div>`);let i=rL[e].card.config;return"input_number"==rL[e].domain?(i.min=this.hass.states[t]?.attributes?.min??-1,i.max=this.hass.states[t]?.attributes?.max??1,i.step=this.hass.states[t]?.attributes?.step??.01):"input_boolean"==rL[e].domain&&(r="on"==r),j`${this.buildMoreInfoButton(e)} ${this.buildSelector(rL[e].name,e,i,r)}${a} ${rL[e].card.resetButton?this.buildResetButton(e):""}`}setupIds(){this.dataId&&!this.personEntityId&&(this.personEntityId=Object.keys(this.hass.states).find(e=>e.startsWith("person.")&&this.hass.states[e].attributes.user_id==this.dataId))}applyThemeMode(){if(this.darkMode!=this.hass.themes?.darkMode){this.darkMode=this.hass.themes?.darkMode;let e=this.shadowRoot?.getElementById(rZ);if(e){let t=[];for(let[e,r]of Object.entries(this.hass.themes?.themes[tw].modes?.[this.darkMode?"dark":"light"]??{}))t.push(`--${e}: ${r};`);e.textContent=`
			...
			`,e.shadowRoot?.appendChild(t)}}connectedCallback(){super.connectedCallback(),rz({targets:[this],id:this.dataId??""}).then(e=>{this.unsubscribers=e})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribers.forEach(async e=>{e()})}static get styles(){return l`:host{width:var(--width);font-family:var(--font-family)}.card-content{display:flex;flex-direction:column;padding:16px;margin:0;gap:20px}.subtitle{margin-top:-24px;padding:0 16px 16px;color:var(--secondary-text-color);font-size:var(--md-sys-typescale-label-large-size,14px);font-weight:var(--md-sys-typescale-label-large-weight,500);line-height:var(
					...
					.25px
				);padding:12px 16px 8px;max-width:calc(var(--width) - 64px);white-space:pre-wrap;z-index:2;pointer-events:none;opacity:0;transition:opacity 150ms linear}.description:has(+ .more-info:hover){opacity:1}@media (width < 450px){.description{translate:0 -40px;max-width:calc(var(--width) - 24px)}}.semantic-colors{position:absolute;width:calc(100% - 44px);margin:0 12px;translate:0 12px;border-radius:4px;overflow:hidden}.semantic-color{flex:1;height:20px}`}}rj([eh()],rq.prototype,"hass",void 0),rj([eh()],rq.prototype,"dataId",void 0),rj([ed()],rq.prototype,"tabBarIndex",void 0);var rY=function(e,t,r,a){var i,n=arguments.length,o=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,r):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,a);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(o=(n<3?i(o):n>3?i(t,r,o):i(t,r))||o);return n>3&&o&&Object.defineProperty(t,r,o),o};class rK extends es{constructor(){super(...arguments),this.tabBarIndex=0,this.tabs=["you","everyone","devices"],this.darkModeIndex=0,this.darkModes=["auto","light","dark"],this.people=[],this.devices=[]}buildHeader(){let e=t.i8,r=this.hass.themes.themes[tw].version;return j`<div class="header"><ha-menu-button slot="navigationIcon" .hass="${this.hass}" .narrow="${this.narrow}"></ha-menu-button><div class="versions"><span class="version">Module v${e}</span> <span class="version">Theme v${r}</span></div></div>`}handleTabBar(e){let t=this.tabs.indexOf(e.detail.name);this.tabBarIndex!=t&&(this.tabBarIndex=t)}buildTabBar(e,t,r){return j`<sl-tab-group @sl-tab-show="${t}">${r.map((t,r)=>j`<sl-tab slot="nav" panel="${t}" .active="${r==e}">${t}</sl-tab>`)}</sl-tab-group>`}buildSectionHeader(e,t){return j`<div class="section-header"><div class="title">${e}</div><div class="description">${t}</div></div>`}handleThemeMode(e){this.darkModeIndex+=1,this.darkModeIndex>this.darkModes.length-1&&(this.darkModeIndex=0);let t={auto:void 0,light:!1,dark:!0}[this.darkModes[this.darkModeIndex]],r=new Event("settheme",{bubbles:!0,composed:!0});r.detail={theme:tw,dark:t},this.dispatchEvent(r)}buildThemeModeFAB(){let e={auto:"mdi:theme-light-dark",light:"mdi:white-balance-sunny",dark:"mdi:weather-night"}[this.darkModes[this.darkModeIndex]];return j`<div class="theme-mode-fab" @click="${this.handleThemeMode}"><ha-icon .icon="${e}"></ha-icon></div>`}setupIds(){this.people.length||(this.people=Object.keys(this.hass.states).filter(e=>e.startsWith("person.")&&this.hass.states[e].attributes.user_id&&this.hass.states[e].attributes.user_id!=this.hass.user?.id)),this.devices.length||(this.devices=Object.keys(window.browser_mod?.browsers??{}).filter(e=>e!=window.browser_mod?.browserID))}render(){let e;this.setupIds(),this.hass.user?.is_admin||(this.tabBarIndex=0);let t=j`${"Material Rounded"in this.hass.themes.themes?tT(`Your theme install is corrupted! The legacy Material Rounded theme was not properly removed and is possibly overwriting ${tw} Theme. Delete the config/themes/material_rounded folder from your Home Assistant server.`,"error"):""} ${!(tw in this.hass.themes.themes)?tT(`You do not have ${tw} Theme installed! This module is made to work with ${tw} Theme and will not function properly otherwise. Install it using HACS.`,"error"):!this.hass.themes.theme.includes(tw)?tT(`You are not using ${tw} Theme! Switch to it using the floating action button at the bottom of the page.`,"warning"):""}`;switch(this.tabBarIndex){case 2:e=j`${window.browser_mod?j`${tT("Remember to register devices with Brower Mod!")} ${this.buildSectionHeader("This Device","Your settings for this device, prioritized over all other settings.")}<material-you-config-card .hass="${this.hass}" .dataId="${window.browser_mod?.browserID}"></material-you-config-card>${this.buildSectionHeader("Other Devices","Other devices registered with Browser Mod.")} ${this.devices.map(e=>j`<material-you-config-card .hass="${this.hass}" .dataId="${e}"></material-you-config-card>`)}`:tT("Device settings requires Browser Mod, which can be installed using HACS.","error")}`;break;case 1:e=j`${this.buildSectionHeader("Everyone!","Default settings for all users and devices.")}<material-you-config-card .hass="${this.hass}"></material-you-config-card>${this.buildSectionHeader("Everyone Else","Other users on this Home Assistant instance.")} ${this.people.map(e=>j`<material-you-config-card .hass="${this.hass}" .dataId="${this.hass.states[e].attributes.user_id}"></material-you-config-card>`)}`;break;default:e=j`${this.buildSectionHeader("You!",`Your personal ${tw} settings.`)}<material-you-config-card .hass="${this.hass}" .dataId="${this.hass.user?.id}"></material-you-config-card>${window.browser_mod&&!this.hass.user?.is_admin?j`${this.buildSectionHeader("This Device","Settings for this device.")}<material-you-config-card .hass="${this.hass}" .dataId="${window.browser_mod?.browserID}"></material-you-config-card>`:""}`}return j`${this.buildHeader()}<div class="content">${this.hass.user?.is_admin?this.buildTabBar(this.tabBarIndex,this.handleTabBar,this.tabs):""} ${t}<div class="page-header"><div class="title">${tw} Utilities</div><div class="description">Design your own Material Design 3 dynamic color theme.</div></div>${e}</div>${this.buildThemeModeFAB()}`}firstUpdated(){this.darkModeIndex=this.darkModes.indexOf(this.hass.themes.darkMode?"dark":"light")}static get styles(){return l`:host{font-family:var(--font-family);color:var(--primary-text-color);background-color:var(
					--lovelace-background,
					...
					var(--mdc-fab-box-shadow)
						...
						var(--mdc-fab-box-shadow)
					)}.theme-mode-fab:hover::after{opacity:.08}}.theme-mode-fab:active::after,.theme-mode-fab:focus-visible::after{opacity:.18}`}}rY([eh()],rK.prototype,"hass",void 0),rY([eh()],rK.prototype,"narrow",void 0),rY([eh()],rK.prototype,"route",void 0),rY([eh()],rK.prototype,"panel",void 0),rY([ed()],rK.prototype,"tabBarIndex",void 0),rY([ed()],rK.prototype,"darkModeIndex",void 0),async function(){if(window.MaterialYouInit)return;window.MaterialYouInit=!0,rS(window),tE(document.querySelector("html"),`${tw} Utilities v${t.i8}`);let e=await tA();new MutationObserver(async t=>{for(let r of t)for(let t of r.addedNodes)if("IFRAME"==t.nodeName){let t=await tC(e.shadowRoot,"iframe"),r=await tP(t,"contentWindow");rS(r);let a=await tP(r,"document"),i={targets:[await tC(a,"body")]};for(let e of[tR,rD,rB])await e(i)}}).observe(e.shadowRoot,{subtree:!0,childList:!0}),customElements.define(`${tk}-config-card`,rq),customElements.define(`${tk}-panel`,rK);let r=async t=>{if(t>1e4)return;let a=e.hass?.themes?.theme;if(!a)return void setTimeout(()=>{r(t)},2*t);if(a.includes(tw)){let e={targets:[await tC(document,"html")]};for(let t of[tO,tR,rD,rB,rT])await t(e)}};r(100),rz({});let a=async()=>{let e=(await tA()).hass,t=e.user?.id;if(e.connection.connected&&t){e.connection.subscribeEvents(()=>tR({}),"themes_updated"),e.user?.is_admin&&e.connection.subscribeEvents(e=>{e?.data?.service=="set_theme"&&setTimeout(()=>tR({}),1e3)},"call_service");return}setTimeout(()=>a(),100)};a()}()})()})();